...
public partial class InstallationService
{
    ...
    protected virtual async Task InstallStoresAsync()
    {
        ...
        var stores = new List<Store>
        {
            new() {
                Name = "FasalShakti",
                DefaultTitle = "FasalShakti",
                DefaultMetaKeywords = string.Empty,
                DefaultMetaDescription = string.Empty,
                HomepageTitle = "Fasal Shakti",
                HomepageDescription = "Fasal Shakti",
                Url = storeUrl,
                SslEnabled = _webHelper.IsCurrentConnectionSecured(),
                Hosts = "fasalshakti.com,www.fasalshakti.com",
                DisplayOrder = 1,
                //should we set some default company info?
                CompanyName = "Fasal Shakti",
                CompanyAddress = "India, M.P",
